...
@implementation WordsViewController_iPad
...
- (void)viewDidLoad {
    ...
    self.titleLabel.text = NSLocalizedString(@"生词本", @"");
    ...
    //设置导航条文字
    UILabel* label = [EnglishFunAppDelegate createNavTitleView:NSLocalizedString (@"生词本",@"")];
...
- (void)parserDidFinish:(Parser *)aParser {
    ...
    if (word)
    {
        WordCardViewController_iPad *wordCardViewController = [[WordCardViewController_iPad alloc] initWithNibName:@"WordCardView_iPad" bundle:nil];
