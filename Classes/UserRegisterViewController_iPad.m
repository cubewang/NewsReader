...
@interface UserRegisterViewController_iPad ()
...
@synthesize emailPromptBgView;
@synthesize emailPromptTableView;
...
- (void)viewDidLoad {
    ...
    self.registerLabel.text = NSLocalizedString(@"注册", @"");
    self.titleLabel.text = NSLocalizedString(@"用户注册", @"");
    ...
    self.nickNameTextField.placeholder = NSLocalizedString(@"昵称", @"");
