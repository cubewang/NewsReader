...
@synthesize backItem;
@synthesize loginButtonLabel;
@synthesize registerButtonLabel;
...
- (IBAction)registerUser:(id)sender {
    ...
    UserRegisterViewController_iPad  *viewController = [[UserRegisterViewController_iPad alloc] initWithNibName:@"UserRegisterView_iPad" 
                                                                                                         bundle:nil];
...
- (void)viewDidLoad {
    ...
    self.emailPromptTableView.delegate = self;
    ...
    self.emailTextField.placeholder = NSLocalizedString(@"用户名（邮箱）", @"");
    self.passwordTextField.placeholder = NSLocalizedString(@"密码（未设置可不填）", @"");
    
    self.titleLabel.text = NSLocalizedString(@"用户登录", @"");
    [self.backItem setTitle:NSLocalizedString(@"返回", @"") forState:UIControlStateNormal];
    self.registerButtonLabel.text = NSLocalizedString(@"没有帐号, 请注册", @"");
    self.loginButtonLabel.text = NSLocalizedString(@"登录", @"");
}
...
- (void)dealloc {
    ...
    self.registerButtonLabel = nil;
    self.loginButtonLabel = nil;
