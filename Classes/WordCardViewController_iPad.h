...
@interface WordCardViewController_iPad : UIViewController<NSFetchedResultsControllerDelegate,UITableViewDelegate,UITableViewDataSource >
{
    Word *_word;
